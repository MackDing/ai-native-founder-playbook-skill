...
| Skill | 触发词 | 功能 |
| --- | --- | --- |
| `$ai-native-founder-playbook` | 创业想法、创业想法验证、AI 原生创业、customer discovery、problem-solution fit、MVP scope、MVP 范围、architecture context、PMF、产品市场匹配、launch operations、发布运营、GTM、founder bottleneck、创始人瓶颈、scale-stage moat、护城河、增长闭环 | 判断创业阶段、识别下一道 evidence gate、生成 founder-agent workflows，并产出可复用策略文档。 |
